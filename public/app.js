class TranscriptionApp {
    ...
    async setupAuth() {
        // Get auth token from Clerk when making API calls
    ...
    async loadServerFiles() {
        ...
        try {
            ...
            if (this.serverFiles.length === 0) {
                filesGrid.innerHTML = '<div class="no-files-message">📁 No files found in uploads folder.<br><small>Upload files to your QNAP uploads folder first.</small></div>';
            } else {
    ...
    renderServerFiles() {
        ...
        filesGrid.innerHTML = this.serverFiles.map((file, index) => {
            ...
            return `
                <div class="file-card" onclick="app.selectServerFile(${index})" id="serverFile${index}">
